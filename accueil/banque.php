                            ...
                            <div class="col-lg-12">
                                <div class="card">
                                    ...
                                    <div class="card-body card-block">
                                        <form method="POST" action="../controller/operationBanque.php">
                                            <div class="col-6">
                                                    <div class="form-group">
                                                        <label>Le coffre actuel de la banque contient : </label>
                                                        <br>
                                                        <div class="input-group">
                                                            <div class="input-group-addon">
                                                                <i class="fas fa-dollar-sign"></i>
                                                            </div>
                                                            <input type="number" id="idCompte" name="montant" placeholder="la somme à rajouter" class="form-control" min=1 required="required" disabled="disabled" value="<?php echo($res[0]['somme']) ?>">
                                                        </div>
                                                    </div>

                                                    <div class="form-group">
                                                        <label>Le coffre des impots contient :</label>
                                                        <br>
                                                        <div class="input-group">
                                                            <div class="input-group-addon">
                                                                <i class="fas fa-dollar-sign"></i>
                                                            </div>
                                                            <input type="number" id="idCompte" name="montant" placeholder="la somme à rajouter" class="form-control" min=1 required="required" disabled="disabled" value="<?php echo($res[1]['somme'])?>">
                                                        </div>
                                                        <br>
                                                    </div>
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <div class="input-group">
                                                            ...
                                                            <select id="Epargne" name="banque" class="form-control" required="required">
                                                                <option value="coffre">Banque</option>
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <div class="input-group">
                                                            ...
                                                            <select id="Epargne" name="operation" class="form-control" required="required">
                                                                <option value="update">Modifier le compte</option>
                                                    ...
                                                    <div class="form-group">
                                                        <label>Inserer la valeur</label>
                                                        <br>
                                                        <div class="input-group">
                                                            <div class="input-group-addon">
                                                                <i class="fas fa-dollar-sign"></i>
                                                            </div>
                                                            <input type="number" id="idCompte" name="montant" placeholder="la somme à rajouter" class="form-control" min=1 required="required">
                                                        </div>
                                                        <br>
                                                    </div>
