<?php 
    ...
    require('../controller/assurance.php');
?>
<!DOCTYPE html>
<html lang="en">
                ...
                <div class="section__content section__content--p30">
                    <div class="container-fluid">
                        <div class="row">
                            ...
                            <div class="col-lg-12">
                                <div class="card">
                                    <div class="card-header">Création assurance - non client</div>
                                    ...
                                    <div class="card-body card-block">
                                        <form action="../controller/operationAssurance.php" method="post" autocomplete="" class="">
                                            <div class="row">
                                                <div class="col-6">
                                                ...
                                                <div class="col-6">
                                                    <div class="form-group">
                                                        <div class="input-group">
                                                            ...
                                                            <input type="number" id="idCompte" name="frais" placeholder="Frais" class="form-control" min=1 required="required">
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-actions form-group">
                                                <button type="submit" name="creerAssuranceNouveau" class="btn btn-lg btn-info btn-block">
                            ...
                            <div class="col-lg-12">
                                <div class="card">
                                    <div class="card-header">Création assurance - client</div>
                                    ...
                                    <div class="card-body card-block">
                                        <form action="../controller/operationAssurance.php" method="post" autocomplete="" class="">
                                            ...
                                            <div class="form-actions form-group">
                                                <button type="submit" name="creerAssuranceCli" class="btn btn-lg btn-info btn-block">
                                                <i class="fa fa-check fa-lg"></i>&nbsp;
                                                Créer le compte</button>
                                            </div>
                                        </form>
