                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-12">
                                <div class="card">
                                    ...
                                    <?php 
                                        if(isset($_SESSION['epargne_alimenter-success'])){
                                    ?>
                                        <div class="alert alert-success alert-dismissible fade show" role="alert">
                                          <strong>Succès !</strong> <?php echo($_SESSION['epargne_alimenter-success'])?>
                                          <button type="button" class="close" data-dismiss="alert" aria-label="Close">
                                            <span aria-hidden="true">&times;</span>
                                          </button>
                                        </div>
                                    <?php
                                        unset($_SESSION['epargne_alimenter-success']) ;      
                                        }elseif (isset($_SESSION['epargne_alimenter-error'])) {
                                    ?>
                                        <div class="alert alert-danger alert-dismissible fade show" role="alert">
                                          <strong>Erreur !</strong> <?php echo($_SESSION['epargne_alimenter-error'])?>
                                          <button type="button" class="close" data-dismiss="alert" aria-label="Close">
                                            <span aria-hidden="true">&times;</span>
                                          </button>
                                        </div>
                                    ...
                                    <?php
                                        ...
                                        unset($_SESSION['epargne_alimenter-error']) ;       
                                    ?>
                                    
                                    <div class="card-header">Alimenter les comptes </div>
                                    <div class="card-body card-block">
                                        <form method="POST" action="../controller/alimenterComptes.php">
                                            <div class="col-6">
                                                    <div class="form-group">
                                                        <label>Choisir le type de compte à alimenter</label>
                                                        <br>
                                                    ...
                                                    <div class="form-group">
                                                        <label>Inserer la somme à rajouter</label>
                                                        <br>
                                                        <div class="input-group">
                                                            <div class="input-group-addon">
