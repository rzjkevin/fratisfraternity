<?php 
    ...
    require('../controller/consulterPret.php');
?>
<!DOCTYPE html>
<html lang="en">
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-12">
                                <div class="card">
                                    ...
                                    <?php 
                                        if(isset($_SESSION['epargneF_success'])){
                                    ?>
                                        <div class="alert alert-success alert-dismissible fade show" role="alert">
                                          <strong>Succès !</strong> <?php echo($_SESSION['epargneF_success'])?>
                                          <button type="button" class="close" data-dismiss="alert" aria-label="Close">
                                            <span aria-hidden="true">&times;</span>
                                          </button>
                                        </div>
                                    <?php
                                        unset($_SESSION['epargneF_success']) ;      
                                        }elseif (isset($_SESSION['epargneF_error'])) {
                                    ?>
                                        <div class="alert alert-danger alert-dismissible fade show" role="alert">
                                          <strong>Erreur !</strong> <?php echo($_SESSION['epargneF_error'])?>
                                          <button type="button" class="close" data-dismiss="alert" aria-label="Close">
                                            <span aria-hidden="true">&times;</span>
                                          </button>
                                        </div>
                                    ...
                                    <?php
                                        ...
                                        unset($_SESSION['epargneF_error']) ;       
                                    ?>
                                    
                                    <div class="card-header">Clôturer un prêt </div>
                                    <div class="card-body card-block">
                                        <form method="GET" action="../controller/fermerPret.php">
                                            <div class="col-6">
                                                    <div class="form-group">
                                                        <label>Inserez le numéro du prêt à clôturer</label>
                                                        <br>
                                                        <div class="input-group">
                                                            <div class="input-group-addon">
                                                                <i class="fa fa-list-ol"></i>
                                                            </div>
                                                            <input type="number" id="idCompte" name="idCompte" placeholder="Numero de prêt" class="form-control" min=1 required="required">
                                                        </div>
                                                        <br>
