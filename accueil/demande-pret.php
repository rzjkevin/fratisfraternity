                ...
                <div class="section__content section__content--p30">
                    <div class="container-fluid">
                        <div class="row">
                            ...
                            <div class="col-lg-12">
                                <div class="card">
                                    <div class="card-header">Demande de prêt - non client</div>
                                    
                                    <?php 
                                        if(isset($_SESSION['creationAssuranceNonCli_success'])){
                                    ?>
                                        <div class="alert alert-success alert-dismissible fade show" role="alert">
                                          <strong>Succès !</strong> <?php echo($_SESSION['creationAssuranceNonCli_success'])?>
                                          <button type="button" class="close" data-dismiss="alert" aria-label="Close">
                                            <span aria-hidden="true">&times;</span>
                                          </button>
                                        </div>
                                    <?php
                                        unset($_SESSION['creationAssuranceNonCli_success']) ;      
                                        }elseif (isset($_SESSION['creationAssuranceNonCli_error'])) {
                                    ?>
                                        <div class="alert alert-danger alert-dismissible fade show" role="alert">
                                          <strong>Erreur !</strong> <?php echo($_SESSION['creationAssuranceNonCli_error'])?>
                                          <button type="button" class="close" data-dismiss="alert" aria-label="Close">
                                            <span aria-hidden="true">&times;</span>
                                          </button>
                                        </div>
                                    ...
                                    <?php
                                        ...
                                        unset($_SESSION['creationAssuranceNonCli_error']) ;       
                                    ?>

                                    <div class="card-body card-block">
                                        <form action="../controller/demandePret.php" method="post" autocomplete="" class="">
                                            <div class="row">
                                                <div class="col-6">
                                                ...
                                                <div class="col-6">
                                                    <div class="form-group">
                                                        <div class="input-group">
                                                            ...
                                                            <input type="number" id="idCompte" name="sommePreter" placeholder="Somme à prêter" class="form-control" min=1 required="required">
                                                        </div>
                                                    </div>
                                                </div>
                                                    ...
                                                    <div class="form-group">
                                                        <div class="input-group">
                                                            <div class="input-group-addon">
                                                             ...
                                                             <input type="number" id="idCompte" name="sommeArendre" placeholder="Somme à rendre" class="form-control" min=1 required="required">
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                                ...
                                                <div class="col-6">
                                                    <div class="form-group">
                                                        <div class="input-group">
                                                            ...
                                                            <input type="date" id="dateFin" name="dateFin" placeholder="Date creation du compte" class="form-control" required="required">
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-actions form-group">
                                                <button type="submit" name="creerPretNouveau" class="btn btn-lg btn-info btn-block">
                                                <i class="fa fa-check fa-lg"></i>&nbsp;
                                                Valider le prêt</button>
                                            </div>
                                        </form>
                                    </div>
                                </div>
                            ...
                            <!-- ASSURANCE DEJA CLIENT  -->

                            <div class="col-lg-12">
                                <div class="card">
                                    <div class="card-header">Demande de prêt - client</div>
                                    
                                    <?php 
                                        if(isset($_SESSION['creationAssuranceCli_success'])){
                                    ?>
                                        <div class="alert alert-success alert-dismissible fade show" role="alert">
                                          <strong>Succès !</strong> <?php echo($_SESSION['creationAssuranceCli_success'])?>
                                          <button type="button" class="close" data-dismiss="alert" aria-label="Close">
                                            <span aria-hidden="true">&times;</span>
                                          </button>
                                        </div>
                                    <?php
                                        unset($_SESSION['creationAssuranceCli_success']) ;      
                                        }elseif (isset($_SESSION['creationAssuranceCli_error'])) {
                                    ?>
                                        <div class="alert alert-danger alert-dismissible fade show" role="alert">
                                          <strong>Erreur !</strong> <?php echo($_SESSION['creationAssuranceCli_error'])?>
                                          <button type="button" class="close" data-dismiss="alert" aria-label="Close">
                                            <span aria-hidden="true">&times;</span>
                                          </button>
                                        </div>
                                    ...
                                    <?php
                                        ...
                                        unset($_SESSION['creationAssuranceCli_error']) ;       
                                    ?>
                                
                                    <div class="card-body card-block">
                                        <form action="../controller/test.php" method="post" autocomplete="" class="">
                                            <div class="row">
                                                <div class="col-6">
                                                    <div class="form-group">
                                                        <div class="input-group">
                                                            ...
                                                            <select id="client" name="client" class="form-control" required="required">
                                                                <?php foreach ($res as $key) {
                                                                ?>
                                                                <option value="<?php echo($key['id']) ?>"><?php echo($key['Nom'].' '.$key['Prenom'])?></option>
                                                                <?php
                                                                }?>
                                                            </select>
                                                        </div>
                                            ...
                                            <div class="form-actions form-group">
                                                <button type="submit" name="creerPretCli" class="btn btn-lg btn-info btn-block">
                                                <i class="fa fa-check fa-lg"></i>&nbsp;
                                                Valider le prêt</button>
                                            </div>
                                        </form>
