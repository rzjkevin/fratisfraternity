<?php 
    ...
    require('../controller/consulterAssurance.php');
?>
<!DOCTYPE html>
<html lang="en">
                ...
                <div class="section__content section__content--p30">
                    <div class="container-fluid">
                        <div class="row">
                            ...
                            <div class="col-lg-12">
                                <div class="card">
                                    <div class="card-header">Liste des comptes actifs </div>
                                            ...
                                            <tbody id="myTable">
                                                ...
                                                ?>
                                                    <tr>
                                                        ...
                                                        <td><?php echo (strtoupper($key['BanquierEnCharge'])); ?></td>
                                                        <td><?php echo ($key['DateOuverture'].' | '.$key['DateFermeture']); ?></td>
                                                        <td><?php echo ($key['commentaire']); ?></td>
                                                    <tr>
                                                <?php
                                                    }
                                                ?>
